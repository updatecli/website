...
| incminor| | false | [T] Boolean that defines if the chart version should bump the minor version
| incpatch| | false | [T] Boolean that defines if the chart version should bump the patch version
| incmajor| | false | [T] Boolean that defines if the chart version should bump the major version
|===
