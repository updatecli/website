...
```
# amd64
sudo zypper install https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_amd64.rpm
# arm64
sudo zypper install https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_arm64.rpm
# armv6
sudo zypper install https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_armv6.rpm
```
...
```
# amd64
curl -sL -o/var/cache/apt/archives/updatecli_amd64.deb https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_amd64.deb
# arm64
curl -sL -o/var/cache/apt/archives/updatecli_amd64.deb https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_arm64.deb
# armv6
curl -sL -o/var/cache/apt/archives/updatecli_amd64.deb https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_armv6.deb
```
...
```
# amd64
dnf install https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_amd64.rpm
# arm64
dnf install https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_arm64.rpm
# armv6
dnf install https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_armv6.rpm
```
...
```
# amd64
curl -sL -o/tmp/updatecli_amd64.tgz https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_amd64.tgz
# arm64
curl -sL -o/tmp/updatecli_arm64.tgz https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_arm64.tgz
# armv6
curl -sL -o/tmp/updatecli_armv6.tgz https://github.com/updatecli/updatecli/releases/download/v0.38.1/updatecli_armv6.tgz
```
