...
----
# amd64
curl -sSL -o /tmp/updatecli_amd64.deb https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_amd64.deb
sudo apt install /tmp/updatecli_amd64.deb

# arm64
curl -sSL -o /tmp/updatecli_arm64.deb https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_arm64.deb
sudo apt install /tmp/updatecli_arm64.deb

# armv6
curl -sSL -o /tmp/updatecli_armv6.deb https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_armv6.deb
...
----
# amd64
sudo dnf install https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_amd64.rpm

# arm64
sudo dnf install https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_arm64.rpm

# armv6
sudo dnf install https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_armv6.rpm
----
...
----
# amd64
sudo zypper install https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_amd64.rpm

# arm64
sudo zypper install https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_arm64.rpm

# armv6
sudo zypper install https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_armv6.rpm
----
...
----
# amd64
curl -sSL -o /tmp/updatecli_amd64.apk https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_amd64.apk
...
----
# amd64
curl -sSL -o /tmp/updatecli.tar.gz https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_Linux_x86_64.tar.gz

# arm64
curl -sSL -o /tmp/updatecli.tar.gz https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_Linux_arm64.tar.gz

# armv6
curl -sSL -o /tmp/updatecli.tar.gz https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_Linux_arm.tar.gz
...
----
# Apple silicon
curl -sSL -o /tmp/updatecli.tar.gz https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_Darwin_arm64.tar.gz

# Intel
curl -sSL -o /tmp/updatecli.tar.gz https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_Darwin_x86_64.tar.gz
...
----
# amd64
Invoke-WebRequest -Uri https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_Windows_x86_64.zip -OutFile updatecli.zip

# arm64
Invoke-WebRequest -Uri https://github.com/updatecli/updatecli/releases/download/v0.121.0/updatecli_Windows_arm64.zip -OutFile updatecli.zip
...
Both are also published per release, for example `ghcr.io/updatecli/updatecli:v0.122.0`.
