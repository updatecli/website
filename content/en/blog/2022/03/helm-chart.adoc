...
* link:/docs/plugins/resource/yaml/[YAML]
* link:/docs/plugins/resource/github_release/[GitHub Release]
* link:/docs/plugins/resource/helm_chart/[Helm Chart]
* link:/docs/plugins/scm/github/[GitHub Repository]
* link:/docs/plugins/actions/github/[GitHub Pullrequest]
* link:/docs/plugins/resource/docker_image/[Docker Image]
